# Example for I2C LCD SSD1306 on Nuvoton's Mbed CE enabled boards
...
1.  Clone the example and navigate into it
    ```
    $ git clone https://github.com/mbed-nuvoton/NuMaker-mbed-ce-I2C-SSD1306-example
    $ cd NuMaker-mbed-ce-I2C-SSD1306-example
...
Flash by drag-n-drop built image `NuMaker-mbed-ce-I2C-SSD1306-example.bin` or `NuMaker-mbed-ce-I2C-SSD1306-example.hex` onto **NuMaker-PFM-NUC472** board
